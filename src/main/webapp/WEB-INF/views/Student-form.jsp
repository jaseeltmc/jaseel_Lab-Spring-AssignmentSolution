...
<body>
	<div class="container">
		...
		<form action="/StudentManagement/students/save" method="post">
			...
			<input type="text"  name="firstName" value="${Student.firstName}" placeholder="FirstName" class="form-control mb-4 col-4">
			</div>
			<div class="form-inline">
			<input type="text"  name="lastName" value="${Student.lastName}" placeholder="LastName" class="form-control mb-4 col-4">
			</div>
			<div class="form-inline">
